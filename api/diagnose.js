...
- 상단에 MY, 국내, 해외, 상품/연금, 혜택 탭이 있고 아래에 평가금/평가금액순/수익률/주식 탭이 보이는 화면도 정상적인 보유종목 화면입니다.
- '주문가능원화'는 현금성 대기자금입니다. holdings에는 넣지 말고 summary나 diagnosis에서 현금 여력으로만 언급하세요.

화면에서 같은 의미로 봐야 하는 항목:
- 종목명: 삼성전자, 삼성전자우, 삼성SDI, LG전자, 현대모비스, RISE 200위클리커버드콜, TIGER 미국S&P500, KODEX 200, JEPQ, QQQI, 리게티 컴퓨팅처럼 보이는 주식/ETF/코인 이름.
...
- 화면 상단의 '평가금 2,670,300원'처럼 전체 평가금이 있고 아래에 'RISE 200위클리커버드콜 2,267,300원', '삼성전자우 403,000원'처럼 종목별 평가금액이 있으면 각각 84.9%, 15.1%처럼 전체 평가금 대비 비중을 계산하세요.
- 종목명 아래의 '158주', '2주'는 수량입니다. 오른쪽 굵은 원화 금액을 평가금액으로 사용하고, 바로 아래 빨간/파란 퍼센트를 return_pct로 사용하세요.
...
- MY/국내/해외 탭형: 상단에 평가금 카드가 있고 아래에 '평가금액순', '수익률' 정렬과 종목 리스트가 보이면 보유종목 화면입니다.
- 주문가능원화, 나의배당, 주식 모으기, 물타기 같은 메뉴 아이콘은 종목이 아닙니다.

반드시 읽을 것:
- 종목명: 한글/영문/ETF/코인 이름. 예: 삼성전자, 삼성전자우, 삼성SDI, LG전자, 현대모비스, 미래에셋벤처투자, 로보티즈, HPSP, RISE 200위클리커버드콜, TIGER 미국S&P500, KODEX 200, ISHARES SILVER TRUST, JEPQ, QQQI, 리게티 컴퓨팅.
...
- 예시: 평가금 2,670,300원 / RISE 200위클리커버드콜 2,267,300원 -3.29% / 삼성전자우 403,000원 +87.35%가 보이면 holdings는 두 종목이고 weight는 약 84.9, 15.1입니다.
- JSON 객체 하나만 반환하세요.
